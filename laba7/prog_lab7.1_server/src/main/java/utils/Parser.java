...
public class Parser {
    ...
    public static CollectionManager fromXmlToObject(String filePath) {
        try {
            ...
            CollectionManager flats = (CollectionManager) un.unmarshal(new File("collection.xml"));
            ...
            System.out.println("Стартовый файл не найден или пуст. Создан новый collection.xml");
